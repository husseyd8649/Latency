...
export default async function OverviewPage({
  ...
  return (
    <>
      <PageHeader
        title="Overview"
        description={`A summary of your monitoring workspace • Past ${TIME_RANGES.find(r => r.value === timeRange)?.label}`}
        actions={
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1 p-1 rounded-lg border border-[var(--border)] bg-[var(--surface)] mr-2">
      ...
      <div className="flex items-center gap-2 text-xs text-[var(--text-muted)] mb-4 px-1">
        ...
        Showing data for the past {hours} hours
      </div>
