...
export function DeleteAllButton({ count }: { count: number }) {
  ...
  // Reset confirm text whenever modal opens/closes
  useEffect(() => {
    if (!open) {
      setConfirmText("");
      setError(null);
    ...
    <>
      ...
      {open && (
        <div
          ...
          onClick={(e) => {
            // Close on backdrop click, but not while a delete is in flight
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] mt-1 leading-relaxed">
                  ...
                  associated incidents. Status pages will remain but will show
                  no monitors.
                </p>
